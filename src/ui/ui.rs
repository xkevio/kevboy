...
impl Kevboy {
    pub fn run(&mut self) {
        ...
        let frame_buffer = self
            ...
            .iter()
            .map(|c| match *c {
                ScreenColor::White(_) => Green::WHITE,
                ScreenColor::LightGray(_) => Green::LIGHT_GRAY,
                ScreenColor::Gray(_) => Green::GRAY,
                ScreenColor::Black(_) => Green::BLACK,
